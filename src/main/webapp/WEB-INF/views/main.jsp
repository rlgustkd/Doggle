    ...
    <section class="site-section" id="gallery-section">
      <div class="container-fluid">
        ...
        <div class="row no-gutters">
            ...
            <a class="col-6 col-md-6 col-lg-4 col-xl-3 gal-item d-block" data-aos="fade-up" data-aos-delay="100" href="${pageContext.request.contextPath}/resources/images/dogger_img_sm_1.jpg" data-fancybox="gal"><img src="${pageContext.request.contextPath}/resources/images/dogger_img_sm_1.jpg" alt="Image" class="img-fluid"></a>

            <a class="col-6 col-md-6 col-lg-4 col-xl-3 gal-item d-block" data-aos="fade-up" data-aos-delay="100" href="${pageContext.request.contextPath}/resources/images/dogger_img_sm_2.jpg" data-fancybox="gal"><img src="${pageContext.request.contextPath}/resources/images/dogger_img_sm_2.jpg" alt="Image" class="img-fluid"></a>
          
            <a class="col-6 col-md-6 col-lg-4 col-xl-3 gal-item d-block" data-aos="fade-up" data-aos-delay="100" href="${pageContext.request.contextPath}/resources/images/dogger_img_sm_3.jpg" data-fancybox="gal"><img src="${pageContext.request.contextPath}/resources/images/dogger_img_sm_3.jpg" alt="Image" class="img-fluid"></a>

            <a class="col-6 col-md-6 col-lg-4 col-xl-3 gal-item d-block" data-aos="fade-up" data-aos-delay="100" href="${pageContext.request.contextPath}/resources/images/dogger_img_sm_4.jpg" data-fancybox="gal"><img src="${pageContext.request.contextPath}/resources/images/dogger_img_sm_4.jpg" alt="Image" class="img-fluid"></a>
          
            <a class="col-6 col-md-6 col-lg-4 col-xl-3 gal-item d-block" data-aos="fade-up" data-aos-delay="100" href="${pageContext.request.contextPath}/resources/images/dogger_img_sm_5.jpg" data-fancybox="gal"><img src="${pageContext.request.contextPath}/resources/images/dogger_img_sm_5.jpg" alt="Image" class="img-fluid"></a>
          
            <a class="col-6 col-md-6 col-lg-4 col-xl-3 gal-item d-block" data-aos="fade-up" data-aos-delay="100" href="${pageContext.request.contextPath}/resources/images/dogger_img_sm_6.jpg" data-fancybox="gal"><img src="${pageContext.request.contextPath}/resources/images/dogger_img_sm_6.jpg" alt="Image" class="img-fluid"></a>
        ...
        <div class="row">
          <div class="col-md-6 mb-4" data-aos="fade-up"  data-aos-delay="">
            <div class="d-lg-flex blog-entry">
              <figure class="mr-4">
                <a href="single"><img src="${pageContext.request.contextPath}/resources/images/dogger_img_sm_1.jpg" alt="Image" class="img-fluid"></a>
              </figure>
              <div class="blog-entry-text">
                <h3><a href="single">5 Things You Need To Know About Dog Massage</a></h3>
          ...
          <div class="col-md-6 mb-4" data-aos="fade-up"  data-aos-delay="100">
            <div class="d-lg-flex blog-entry">
              <figure class="mr-4">
                <a href="single"><img src="${pageContext.request.contextPath}/resources/images/dogger_img_sm_2.jpg" alt="Image" class="img-fluid"></a>
              </figure>
              <div class="blog-entry-text">
                <h3><a href="single">5 Things You Need To Know About Dog Massage</a></h3>
                <span class="post-meta mb-3 d-block">April 17, 2019</span>
          ...
          <div class="col-md-6 mb-4" data-aos="fade-up"  data-aos-delay="">
            <div class="d-lg-flex blog-entry">
              <figure class="mr-4">
                <a href="single.jsp"><img src="${pageContext.request.contextPath}/resources/images/dogger_img_sm_3.jpg" alt="Image" class="img-fluid"></a>
              </figure>
              <div class="blog-entry-text">
                <h3><a href="single.jsp">5 Things You Need To Know About Dog Massage</a></h3>
                <span class="post-meta mb-3 d-block">April 17, 2019</span>
                <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
                <p><a href="#" class="">Read More..</a></p>
              </div>
          ...
          <div class="col-md-6 mb-4" data-aos="fade-up"  data-aos-delay="100">
            <div class="d-lg-flex blog-entry">
              <figure class="mr-4">
                <a href="single.jsp"><img src="${pageContext.request.contextPath}/resources/images/dogger_img_sm_1.jpg" alt="Image" class="img-fluid"></a>
              </figure>
              <div class="blog-entry-text">
                <h3><a href="single.jsp">5 Things You Need To Know About Dog Massage</a></h3>
                <span class="post-meta mb-3 d-block">April 17, 2019</span>
