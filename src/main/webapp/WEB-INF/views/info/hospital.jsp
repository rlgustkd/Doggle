			...
			<div class="row align-self-center text-center" data-aos="fade-up" data-aos-delay="100">
				<div class="accordion-item" style="width: 100%;">
					<h3 class="mb-0 heading">
						<a class="btn-block" data-toggle="collapse" href="#collapseFive" role="button" aria-expanded="true" aria-controls="collapseFive" style="display: inline;">Doggle이 추천하는 동물 병원 알아보기<span
							class="icon"></span>
						</a>
					</h3>
									...
									<div data-aos="fade-up" data-aos-delay="200">
										<div class="owl-carousel nonloop-block-13">
											<c:forEach items="${hospitalinfo}" var="hospitalinfo">
												<div>
													<figure class="mr-4">
														<img src="${pageContext.request.contextPath}/resources/images/${hospitalinfo.h_photo}" alt="" class="img-fluid">
														<c:out value="${hospitalinfo.h_title }"/>
														</a>
													</figure>
												</div>
											</c:forEach>
				...
				<div class="accordion-item" style="width: 100%;">
					<h3 class="mb-0 heading">
						<a class="btn-block" id="toggle" data-toggle="collapse" href="#collapseSix" role="button" aria-expanded="false" aria-controls="collapseSix" style="display: inline;">
						우리 동네의 동물 병원 알아보기<span class="icon"></span>
						</a>
					</h3>
	...
	<div class="container">
		<div class="row justify-content-center" data-aos="fade-up">
			<div class="col-lg-6 text-center heading-section mb-5">
				...
				<h2 class="text-black mb-2">추천 목록</h2>
			</div>
		</div>
		<form action="saveImage" enctype="multipart/form-data" method="post">
			<input multiple="multiple" type="file" name="file" onchange="fileCheck(this)" accept="image/gif, image/jpeg, image/png" /> 
		...
		<div data-aos="fade-up" data-aos-delay="200">
			<div class="owl-carousel nonloop-block-13">
				<c:forEach items="${hospitalinfo}" var="hospitalinfo">
					<div>
						<figure class="mr-4">
							<img src="${pageContext.request.contextPath}/resources/images/${hospitalinfo.h_photo}" alt="" class="img-fluid"></a>
							<c:out value="${hospitalinfo.h_title }"/>
						</figure>
					</div>
				</c:forEach>
