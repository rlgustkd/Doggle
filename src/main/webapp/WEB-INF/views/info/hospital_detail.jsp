...
<thead>
  <tr>
    <td><img class="absolute" id="h_photo" width="600px" height="500px" src="" class="img-fluid"></td>
  </tr>
</thead>
<tbody>
  <tr>
...
<thead>
  <tr>
    <td class="tg-0pky" id="h_title" style="text-align:center; width:250px; height:50px; font-size:20px; font-weight:bold;"></td>
    <td class="tg-0pky" id="phone" style="text-align:right; width:150px; height:50px; font-size:15px;"></td>
  </tr>
</thead>
<tbody>
  <tr>
    <td class="tg-0pky" colspan="2" style="word-break:break-all" id="h_content"></td>
  </tr>
</tbody>
</table>
...
<button style="width:60px; height:50px;" id="write">등록</button>
</c:if>
