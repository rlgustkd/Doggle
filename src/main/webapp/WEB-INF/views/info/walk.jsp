		...
		<div class="row justify-content-center" data-aos="fade-up">
			<div class="col-lg-6 text-center heading-section mb-5">
				...
				<h2 class="text-black mb-2">
					DOGGLE을 통해 반려견 놀이터를 <br>찾아보세요
				</h2>
				<p>도글 추천 반려견 놀이터, 현재 있는 위치 주변의 반려견 놀이터, 사용자들이 직접 추천하는 반려견 놀이터를 알려줍니다.</p>
			</div>
		</div>
			...
			<div class="row align-self-center text-center" data-aos="fade-up" data-aos-delay="100">
				<div class="accordion-item" style="width: 100%;">
					<h3 class="mb-0 heading">
						<a class="btn-block" data-toggle="collapse" href="#collapseFive" role="button" aria-expanded="true" aria-controls="collapseFive" style="display: inline;">Doggle이 추천하는 애견 놀이터 알아보기<span
							class="icon"></span>
						</a>
					</h3>
					...
					<div id="collapseFive" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
						<div class="body-text">
							<p>도글이 선정한 추천 반려견 놀이터 목록입니다. 제휴 문의: dogglemail@gmail.com</p>
								...
								<div class="container">
									...
									<div data-aos="fade-up" data-aos-delay="200">
										<div class="owl-carousel nonloop-block-13">
											<c:forEach items="${walkinfo}" var="walkinfo">
												<div>
													<figure class="mr-4">
														<a data-toggle="modal" name="detail"> <img src="${pageContext.request.contextPath}/resources/images/${walkinfo.w_photo}" alt="" class="img-fluid"> <input type="hidden"
															id="image" name="image" value="${walkinfo.p_no }" /> <c:out value="${walkinfo.w_title }" /> <br> <c:out value="${walkinfo.phone }" />
														</a>
													</figure>
												</div>
											</c:forEach>
				...
				<div class="accordion-item" style="width: 100%;">
					<h3 class="mb-0 heading">
						<a class="btn-block" id="toggle" data-toggle="collapse" href="#collapseSix" role="button" aria-expanded="false" aria-controls="collapseSix" style="display: inline;"> 우리 동네의 애견 놀이터 알아보기<span
							class="icon"></span>
						</a>
					</h3>
...
<script type="text/javascript">
	...
	$('a[name=detail]').click(function() {
	   ...
	   success: function(data){
		   ...
		   var photo = data.w_photo;
		   $('#w_title').text(data.w_title);
		   $('#phone').text(data.phone);
		   $('#w_content').text(data.w_content);
		   $('#w_photo').attr('src','${pageContext.request.contextPath}/resources/images/'+photo);
		   var lng = data.lng;
		   var lat = data.lat;
			window.setTimeout(function() {
