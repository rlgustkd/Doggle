...
<body>
	...
	<div class="site-wrap">
		...
		<div class="site-mobile-menu site-navbar-target"
			style="font-family: 'Gaegu', cursive; font-size: larger;">
		...
		<header class="site-navbar js-sticky-header site-navbar-target"
			...
			<div class="container">
				<div class="row align-items-center"
					style="font-family: 'Gaegu', cursive; font-size: 30px;">
						...
						<nav class="site-navigation position-relative text-right"
							...
							<ul
								...
								<li class="has-children"><a class="nav-link">Info</a>
									<ul class="dropdown">
										<li><a href="hospital" class="nav-link">병원</a></li>
										<li><a href="hotel" class="nav-link">호텔</a></li>
										<li><a href="walk" class="nav-link">애견 동반</a></li>
										<li><a href="petshop" class="nav-link">애견샵</a></li>
									</ul></li>
								...
								<li class="has-children"><a class="nav-link">Story</a>
									<ul class="dropdown">
										<li><a
											href="../story/freeboard"
											class="nav-link">자유게시판</a></li>
										<li><a href="../story/gallery"
											class="nav-link">사진게시판</a></li>
									</ul></li>
