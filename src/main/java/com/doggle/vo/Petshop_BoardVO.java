...
public class Petshop_BoardVO {
	...
	public String toString() {
		return "Petshop_BoardVO [b_no=" + b_no + ", p_no=" + p_no + ", id=" + id + ", pb_title=" + pb_title
				+ ", pb_content=" + pb_content + ", date=" + date + ", pb_photo=" + pb_photo + ", recommend="
